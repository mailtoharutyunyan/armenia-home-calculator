...
export const STAGES: Stage[] = [
  ...
  // openings and facade are turnkey lines in the estimate, not part of the shell
  { ru: 'Окна, двери, фасад', hy: 'Պատուհաններ, դռներ, ֆասադ', minWeeks: 2, maxWeeks: 4, phase: 'turnkey', sections: ['openings', 'facade'] },
